...
import { AppReviewPage } from '@/components/employee/dashboards/app-manager/AppReviewPage';
...
export default function AppReviewPagePage() {
  ...
  const [mutate, { loading: mutationLoading }] = useMutation(REVIEW_APP);
