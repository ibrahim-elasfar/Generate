...
import { SkillsMatrixPage } from '@/components/employee/dashboards/developer-manager/SkillsMatrixPage';
...
export default function SkillsMatrixPagePage() {
  ...
  return (
    <SkillsMatrixPage 
      data={queryData?.skillDistribution}
