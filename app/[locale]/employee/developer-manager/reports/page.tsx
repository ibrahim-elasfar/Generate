...
import { DeveloperReportsPage } from '@/components/employee/dashboards/developer-manager/DeveloperReportsPage';
...
export default function DeveloperReportsPagePage() {
