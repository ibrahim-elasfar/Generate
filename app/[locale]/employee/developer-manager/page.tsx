...
import { DeveloperManagerDashboard } from '@/components/employee/dashboards/developer-manager/DeveloperManagerDashboard';
...
export default function DeveloperManagerDashboardPage() {
  ...
  const { data: queryData, loading: queryLoading, error: queryError } = useQuery(DEVELOPER_MANAGER_STATS);
  ...
  return (
    <DeveloperManagerDashboard 
      data={queryData?.developerManagerStats}
