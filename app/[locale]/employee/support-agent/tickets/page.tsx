...
import { AllTicketsPage } from '@/components/employee/dashboards/support-agent/OpenTicketsList';
...
export default function AllTicketsPagePage() {
  ...
  const { data: queryData, loading: queryLoading, error: queryError } = useQuery(OPEN_TICKETS);
