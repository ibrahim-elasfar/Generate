...
import { HREmployeesPage } from '@/components/employee/dashboards/hr/HREmployeesList';
...
export default function HREmployeesPagePage() {
  ...
  const { data: queryData, loading: queryLoading, error: queryError } = useQuery(HR_EMPLOYEES);
