...
import { ProjectDetailsPage } from '@/components/employee/dashboards/manager/ProjectDetails';
...
export default function ProjectDetailsPagePage() {
  ...
  const [mutate, { loading: mutationLoading }] = useMutation(UPDATE_PROJECT);
